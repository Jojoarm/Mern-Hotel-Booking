...
const RoomDetails = () => {
  ...
  //onsubmithandler to check availability of room and book the room
      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            ...
            groups. The Guests will be allocated ground flooor according to
            availability. You get the comfortable two bedroom apargtment that
